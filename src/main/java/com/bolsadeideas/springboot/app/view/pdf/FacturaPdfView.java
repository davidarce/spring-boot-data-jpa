...
public class FacturaPdfView extends AbstractPdfView {
    ...
    @Autowired public FacturaPdfView(MessageSource messageSource, LocaleResolver localeResolver) {
        this.messageSource = messageSource;
        this.localeResolver = localeResolver;
    }

    @Override protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
        ...
        tabla2.addCell(cell);
        tabla2.addCell(String.format("%s: %d", messages.getMessage("text.cliente.factura.folio"), factura.getId()));
